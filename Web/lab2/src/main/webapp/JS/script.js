...
const minY = new Big("-3");
const maxY = new Big("3");

let dots = [];

function validateY(yNum) {
    let floatValue = new Big(yNum.replace(',', '.')); // Replace ',' with '.' for consistent parsing
    return (floatValue !== null && floatValue.gt(minY) && floatValue.lt(maxY) );
}
